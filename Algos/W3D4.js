...
function findObjects(criteria, collection) {
    ...
    for(let idx  in  collection){
        ...
        if (criteria.firstName || criteria.lastName || criteria.age ===  collection[idx].firstName || collection[idx].lastName || collection[idx].age  ){
            var newObj = collection.splice(idx, 1)
