...
console.log(coronaVirusAtRisk(people2))
...
function coronaVirusAtRiskFunctional(people) { 
  return people.filter(person => !person.isSocialDistancing && person.friends.some(friend => !friend.isSocialDistancing && friend.hasCovid))
  .map(person => `${person.firstName} ${person.lastName}`);
}

console.log(coronaVirusAtRiskFunctional(people2))